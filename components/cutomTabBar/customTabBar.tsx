...
import { Animated, LayoutChangeEvent, Platform, StyleProp, StyleSheet, View, ViewStyle } from "react-native";
...
const shouldUseHorizontalLabels = ({ state, descriptors, layout, dimensions }: Options) => {
            ...
            <NavigationContext.Provider key={route.key} value={descriptors[route.key].navigation}>
              <NavigationRouteContext.Provider value={route}>
                <BottomTabItem
                  ...
                  icon={
                    options.tabBarIcon ?? (({ color, size }) => <MissingIcon color={color} size={size} />)
                  }
